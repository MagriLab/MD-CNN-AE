...
from project_specific_utils import standard_autoencoder as post_processing
from project_specific_utils.standard_autoencoder import TrainAE
...
def save_results(training_class:TrainAE, 
...
def main(train_id:int, training_config:str, gpu_id:int, memory_limit:int, save_to:str, CPU:bool):
    ...
    # initiate job
    job = TrainAE(training_config, gpu_id)
